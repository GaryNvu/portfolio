...
return (
    <div className="bg-dark-purple p-6 rounded-lg hover:cursor-pointer transition-colors duration-300">
    {image && (
    ...
    <p className="text-text mb-4 line-clamp-3 h-[4.5rem]">{description}</p>
